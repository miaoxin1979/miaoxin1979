...
[![Repo](https://img.shields.io/badge/GitHub-himiao--hk--insurance--audit-black?logo=github)](https://github.com/miaoxin1979/himiao-hk-insurance-audit)
...
```mermaid
flowchart LR
    A["Real-world problem<br/>真实问题"] --> B["AI-assisted workflow<br/>AI 辅助流程"]
    B --> C["Local / private infrastructure<br/>本地与私有基础设施"]
    C --> D["Product system<br/>产品系统"]
    D --> E["Verification & handoff<br/>验证与交接"]
```
...
![AI Agents](https://img.shields.io/badge/AI%20Agents-111827)
![Local LLM](https://img.shields.io/badge/Local%20LLM-0F766E)
